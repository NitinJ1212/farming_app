          ...
          <ul className="list-unstyled">
            <li>
              <div className="product-color-item">
                <a href="#" className="text-dark">
                  <i className="fas fa-apple-alt text-secondary me-2" /> Gold
                </a>
                <span>(1)</span>
              </div>
            </li>
            <li>
              <div className="product-color-item">
                <a href="#" className="text-dark">
                  <i className="fas fa-apple-alt text-secondary me-2" /> Green
                </a>
                <span>(1)</span>
              </div>
            </li>
            <li>
              <div className="product-color-item">
                <a href="#" className="text-dark">
                  <i className="fas fa-apple-alt text-secondary me-2" /> White
                </a>
                <span>(1)</span>
              </div>
            </li>
